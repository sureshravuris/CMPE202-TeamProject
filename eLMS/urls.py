...
admin.site.site_header = "Canvas Administration"
admin.site.site_title = "Canvas Administration Portal"
admin.site.index_title = "Welcome to Canvas Administration Portal"
